...
const Home: NextPage = () => {
    ...
    const renderLanding = (
        <Box mt={40}>
            ...
            <VStack gap={5}>
                <Text mt={4} color={'gray.400'} fontSize="18px" letterSpacing="2px">Proof of Networking</Text>
                <Text color={'gray.300'} fontSize="22px">Hi Anon, log in with your wallet to create or view your profile</Text>
                <CustomConnect />
            </VStack>
        </Box>
    )
          ...
          <Head>
            ...
            <Container maxW={'3xl'}>
                <Stack as={Box} textAlign={'center'} spacing={{ base: 8, md: 14 }} py={{ base: 10, md: 5 }}>
                    ...
                    {isConnected && (!orbis || isLoading) && <Box><Spinner /></Box>}
